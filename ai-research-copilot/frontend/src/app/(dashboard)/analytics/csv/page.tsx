...
export default function CSVAnalysisPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      toast.success("File uploaded. Your CSV is ready for analysis.");
    } catch (err) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">CSV Analysis</h1>
        <p className="text-muted-foreground">Upload and analyze CSV files</p>
      </div>
      <Card>
        <CardHeader>
          <CardTitle>Upload CSV</CardTitle>
          <CardDescription>Select a CSV file to analyze its contents</CardDescription>
        </CardHeader>
